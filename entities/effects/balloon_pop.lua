...
function EFFECT:Init( data )
	...
	for i = 0, NumParticles do
		...
		local Pos = Vector( math.Rand( -1, 1 ), math.Rand( -1, 1 ), math.Rand( 0, 1 ) )
		...
		if ( particle ) then
			...
			particle:SetColor( math.Rand(50,255) * RandDarkness, math.Rand(50,255) * RandDarkness, math.Rand(50,255) * RandDarkness )
